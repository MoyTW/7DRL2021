...
namespace SpaceDodgeRL.library.encounter.rulebook.actions {
  ...
  public class FireProjectileAction : EncounterAction {
    ...
    public static FireProjectileAction CreatePilaAction(string actorId, Entity target) {
      var targetPosition = target.GetComponent<PositionComponent>().EncounterPosition;
